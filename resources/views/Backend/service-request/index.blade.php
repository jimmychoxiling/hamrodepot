@extends('Backend.layouts.app', ['title' => __('Service Request')])
                ...
                <div class="card">
                    ...
                    <!-- Light table -->
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush yajra-datatable" id="serviceReq-datatable">
...
@section('extra-js')
    <script type="text/javascript">
        ...
        $('#serviceReq-datatable').DataTable({
            ajax: {
                type: 'POST',
                url: "{{ route('getServiceRequest-datatable')}}"
            },
            processing: true,
            serverSide: true,
            columns: [
