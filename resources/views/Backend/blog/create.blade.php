                ...
                <div class="col-lg-6 col-7">
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Add DIY & Articles</li>
                        </ol>
                    </nav>
                </div>
            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="mb-0">Add DIY & Articles</h3>
                    </div>
                </div>
                <div class="card-body">
                    @if (count($errors) > 0)
                    ...
                    @endif
                    <form method="post" action="{{ route('blog-store') }}" autocomplete="off" data-parsley-validate="" enctype="multipart/form-data">
                        @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="blog_category_id" id="blog_category_id " class="form-control form-control-alternative" required data-parsley-required-message="Category is required">
                                            ...
                                            @foreach($blog_category as $blog_category_val)
                                                <option value="{{ $blog_category_val->id }}" {{(old('blog_category_id ') == $blog_category_val->id ? 'selected':'')}}>{{$blog_category_val->name}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="author" id="input-author" class="form-control form-control-alternative" placeholder="Author" value="{{ old('author') }}" required  data-parsley-required-message="Author is required">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-alternative" rows="5" name="description"  require data-parsley-required-message="Description is required">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
