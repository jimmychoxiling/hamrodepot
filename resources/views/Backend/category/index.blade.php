            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('category-create') }}" class="btn btn-sm btn-neutral">Add New Category</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card">
                    ...
                    <!-- Light table -->
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush yajra-datatable" id="category-datatable">
...
@section('extra-js')
    <script type="text/javascript">
        ...
        $('#category-datatable').DataTable({
            ajax: {
                type: 'POST',
                url: "{{ route('getCategory-datatable')}}"
            },
            processing: true,
            serverSide: true,
            columns: [
        ...
        //category status
        $(document).on('click', '.statusUpdateCategory', function() {
        var _this = $(this);
        ...
        swal({
                title: "",
                text: "Are you sure? " + isFor + " this Category!",
                type: "warning",
                showCancelButton: true,
                confirmButtonClass: "btn-danger",
            ...
            function(isConfirm) {
                ...
                $.ajax({
                    type: "post",
                    url: "{{route('sub-category-status-update')}}",
                    data: {
                        id: id,
                        status: status,
                    },
