            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('type-create') }}" class="btn btn-sm btn-neutral">Add New
                        Type</a>
                    </div>
                </div>
            </div>
...
@section('extra-js')
    <script type="text/javascript">
        ...
        $(document).on('click', '.delete', function () {
            ...
            swal({
                    title: "",
                    text: "Are you sure? Delete this Type!",
                    type: "warning",
        ...
        //statusUpdateType
        $(document).on('click', '.statusUpdateType', function() {
        var _this = $(this);
        ...
        swal({
                title: "",
                text: "Are you sure? " + isFor + " this Type !",
                type: "warning",
                showCancelButton: true,
                confirmButtonClass: "btn-danger",
