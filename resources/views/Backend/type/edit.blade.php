        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('type-update',['id' => $type->id]) }}" autocomplete="off" data-parsley-validate="" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" id="input-name" class="form-control form-control-alternative" placeholder="Name" value="{{ old('name', $type->name) }}" required autofocus data-parsley-required-message="Name is required">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control form-control-alternative" required data-parsley-required-message="Category is required">
                                            ...
                                            <option value="{{$category->id}}" {{(old('category_id', $type->parent_id) == $category->id ? 'selected':'')}}>{{$category->subCategoryParent->name}} -> {{$category->name}}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control form-control-alternative" rows="5" name="description" require data-parsley-required-message="Description is required">{{ old('description', $type->description) }}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="profile-icon">
                                            ...
                                            <img class='img-responsive' id="uploadPreview1" src="{{ url('storage') . '/' .  $type->image}}" style="height: 150px;">
                                            @else
