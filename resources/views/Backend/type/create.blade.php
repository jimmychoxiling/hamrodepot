        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" action="{{ route('type-store') }}" autocomplete="off" data-parsley-validate="" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="category_id" id="category_id" class="form-control form-control-alternative" required data-parsley-required-message="Sub Category is required">
                                            <option value="" selected disabled>Select Sub Category</option>
                                            @foreach($sub_categories as $category)
                                            <option value="{{ $category->id }}" {{(old('category_id') == $category->id ? 'selected':'')}}>{{$category->subCategoryParent->name}} -> {{$category->name}}</option>
                                            @endforeach
                                        </select>
