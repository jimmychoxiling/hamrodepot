        ...
        <div class="col-xl-12 order-xl-1">
            <div class="card bg-secondary shadow">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form method="post" action="{{ route('brand-store') }}" autocomplete="off" data-parsley-validate="" enctype="multipart/form-data">
                        @csrf
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control form-control-alternative" required data-parsley-required-message="Status is required">
                                            ...
                                            <option value="1" {{(old('status') == '1' ? 'selected':'')}} selected>Approve
                                            </option>
                                            <option value="2" {{(old('status') == '2' ? 'selected':'')}}>In-Active
                                            </option>
