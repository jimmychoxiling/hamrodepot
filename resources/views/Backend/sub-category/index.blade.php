            ...
            <div class="header-body">
                <div class="row align-items-center py-4">
                    ...
                    <div class="col-lg-6 col-5 text-right">
                        <a href="{{ route('sub-category-create') }}" class="btn btn-sm btn-neutral">Add New
                            Sub-Category</a>
                    </div>
                </div>
            </div>
...
@section('extra-js')
    <script type="text/javascript">
        $('#sub-category-datatable').DataTable({
            ajax: {
                type: 'POST',
                url: "{{ route('getSubCategory-datatable')}}"
            },
            processing: true,
            serverSide: true,
            columns: [{
        ...
        $(document).on('click', '.delete', function () {
         ...
         //sub - category status
        $(document).on('click', '.statusUpdateSubCategory', function() {
        var _this = $(this);
        ...
        swal({
                title: "",
                text: "Are you sure? " + isFor + " this Sub Category!",
                type: "warning",
                showCancelButton: true,
                confirmButtonClass: "btn-danger",
