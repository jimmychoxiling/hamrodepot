                ...
                <div class="card">
                    ...
                    <!-- Light table -->
                        <div class="table-responsive">
                            <table class="table align-items-center table-flush yajra-datatable" id="service-datatable">
...
<script src="{{ asset('assets/vendor/sweetalert2/dist/sweetalert2.min.js') }}"></script>
    <script type="text/javascript">
        var serviceTable =  $('#service-datatable').DataTable({
            ajax: {
                type: 'POST',
                url: "{{ route('getService-datatable')}}"
            },
            language: {
                paginate: {
        ...
        $(document).on('click', '.service-status', function (e) {
            ...
            if(!_this.hasClass('no-call')){
                ...
                swal({
                    title: 'Are you sure you want to '+title+' this service?',
                    type: 'warning',
                            ...
                            success: function(data){
                                if(data.success === true){
                                    swal({
                                        ...
                                        if(serviceName != ""){
                                            $(_this).parents('tr').find('.service-name').text(serviceName);
                                        }
                                    });
                                } else {
                                    swal({
