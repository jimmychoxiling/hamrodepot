                    ...
                    <div class="col col-12">
                        <div class="breadcrumb">
                            <ul>
                                ...
                                <li><a href="{{ route('our-products', array('slug2' => $category->slug)) }}"> {{ $category->name }}</a> </li>
                ...
                <div class="row">
                    <div class="col col-12">
                        <div class="mian_list_content">
                            <div class="sidebar">
                                <h1 class="category_title">{{ $sub_category->name }}</h1>
                                <div class="sidebar_list_wrap">
                                    <ul class="sidebar_list_inner">
                                        @foreach($types as $type)
                                            <li class="sidebar_item"><a class="sidebar_link"
                                                                        href="{{ route('our-products', array('slug2' => $category->slug, 'slug3' => $sub_category->slug, 'slug4' => $type->slug)) }}">{{ $type->name }}</a>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div>
                                        ...
                                        @foreach($types as $type)
                                            <div class="product__item">
                                                <div class="product__image">
                                                    <a href="{{ route('our-products', array('slug2' => $category->slug, 'slug3' => $sub_category->slug, 'slug4' => $type->slug)) }}">
