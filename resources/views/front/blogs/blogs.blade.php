...
@section('content')
    ...
    <div id="content" class="main-content">
        <section class="common_banner_section">
            <div class="common_banner" style="background: #fff url({{asset('images/authentication_banner.jpg')}} ) center/ cover fixed;">
        ...
        <section class="main_blog_section card_section">
            <div class="container">
                <div class="row">
                    <div class="col col-9">
                        <div class="card">
                            <div class="mobile_search d-none">
                            ...
                            <div class="blog_list_wrap row">
                                @if(count($blogs) > 0)
                                @foreach($blogs as $blog)
                                <div class="blog_list_item col col-6">
                                    <div class="blog_item_image">
                                        <a href="{{ route('blog-detail', array('slug2' => $blog->slug)) }}">
                                    ...
                                    <div class="blog_item_content">
                                        <h3 class="blog_item_title"><a href="{{ route('blog-detail', array('slug2' => $blog->slug)) }}">{{ $blog->name }}</a></h3>
                                        {!! Str::limit($blog->description, 200, ' ...') !!}</p>
                                        <a href="{{ route('blog-detail', array('slug2' => $blog->slug)) }}" class="blog_item_more">Read more <i class="fa fa-long-arrow-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                                @endforeach
                                @else
                                    <div class="no_data_error">
                                        <div class="no_data_inner">
                                            <div class="no_data_image">
                                                <svg id="b21613c9-2bf0-4d37-bef0-3b193d34fc5d" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" width="647.63626"
